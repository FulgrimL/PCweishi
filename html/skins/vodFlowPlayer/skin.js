...
(function(a) {
	SewisePlayerSkin.ControlBar = function(b, c, k, i) {
		...
		function m(a) {
			a = o + (a.pageY - MH);
			0 < a && a < v && (w.css("height", a), r.css("top", a - E / 2))
		}
		...
		function p(b) {
			...
			X = b.pageY;
			MH != X && (o = w.height(), A = o / v, n.setVolume(A), Y())
		}

		function u(a) {
			e = a.originalEvent;
			1 == e.targetTouches.length && (e.preventDefault(), a = o + (e.targetTouches[0].pageY - MH), 0 < a && a < v && (w.css("height", a), r.css("top", a - E / 2)))
		}
		...
		function G(a) {
			...
			r.unbind("touchend", G);
			if(1 == e.changedTouches.length) X = e.changedTouches[0].pageY, MH != X && (o = w.height(), A = o / v, n.setVolume(A), Y())
		}
